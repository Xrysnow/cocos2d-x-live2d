...
int lua_L2D_Model_getParameterValue(lua_State* tolua_S)
{
	int argc = 0;
	l2d::Model* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_L2D_Model_getParameterValue'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 1)
	{
		...
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_L2D_Model_getParameterValue'", nullptr);
			return 0;
		}
...
#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'lua_L2D_Model_getParameterValue'.", &tolua_err);
#endif
...
int lua_L2D_Model_getParameterMinimumValue(lua_State* tolua_S)
{
	int argc = 0;
	l2d::Model* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_L2D_Model_getParameterMinimumValue'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 1)
	{
		...
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_L2D_Model_getParameterMinimumValue'", nullptr);
			return 0;
		}
...
#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'lua_L2D_Model_getParameterMinimumValue'.", &tolua_err);
#endif
...
int lua_L2D_Model_addParameterValue(lua_State* tolua_S)
{
	int argc = 0;
	l2d::Model* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_L2D_Model_addParameterValue'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 2)
	{
		...
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_L2D_Model_addParameterValue'", nullptr);
			return 0;
		}
...
#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'lua_L2D_Model_addParameterValue'.", &tolua_err);
#endif
...
int lua_L2D_Model_getParameterDefaultValue(lua_State* tolua_S)
{
	int argc = 0;
	l2d::Model* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_L2D_Model_getParameterDefaultValue'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 1)
	{
		...
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_L2D_Model_getParameterDefaultValue'", nullptr);
			return 0;
		}
...
#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'lua_L2D_Model_getParameterDefaultValue'.", &tolua_err);
#endif
...
int lua_L2D_Model_setParameterValue(lua_State* tolua_S)
{
	int argc = 0;
	l2d::Model* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_L2D_Model_setParameterValue'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 2)
	{
		...
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_L2D_Model_setParameterValue'", nullptr);
			return 0;
		}
...
#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'lua_L2D_Model_setParameterValue'.", &tolua_err);
#endif
...
int lua_L2D_Model_getParameterMaximumValue(lua_State* tolua_S)
{
	int argc = 0;
	l2d::Model* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_L2D_Model_getParameterMaximumValue'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 1)
	{
		...
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_L2D_Model_getParameterMaximumValue'", nullptr);
			return 0;
		}
...
#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'lua_L2D_Model_getParameterMaximumValue'.", &tolua_err);
#endif
...
int lua_L2D_Model_multiplyParameterValue(lua_State* tolua_S)
{
	int argc = 0;
	l2d::Model* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_L2D_Model_multiplyParameterValue'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 2)
	{
		...
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_L2D_Model_multiplyParameterValue'", nullptr);
			return 0;
		}
...
#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'lua_L2D_Model_multiplyParameterValue'.", &tolua_err);
#endif
...
int lua_register_L2D_Model(lua_State* tolua_S)
{
	...
	tolua_function(tolua_S, "getParameterValue", lua_L2D_Model_getParameterValue);
	...
	tolua_function(tolua_S, "getParameterMinimumValue", lua_L2D_Model_getParameterMinimumValue);
	...
	tolua_function(tolua_S, "addParameterValue", lua_L2D_Model_addParameterValue);
	tolua_function(tolua_S, "getDirectory", lua_L2D_Model_getDirectory);
	tolua_function(tolua_S, "getParameterDefaultValue", lua_L2D_Model_getParameterDefaultValue);
	tolua_function(tolua_S, "getParameterNames", lua_L2D_Model_getParameterNames);
	tolua_function(tolua_S, "setParameterValue", lua_L2D_Model_setParameterValue);
	...
	tolua_function(tolua_S, "getParameterMaximumValue", lua_L2D_Model_getParameterMaximumValue);
	...
	tolua_function(tolua_S, "multiplyParameterValue", lua_L2D_Model_multiplyParameterValue);
